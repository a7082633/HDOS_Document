...
//按数据项序号读数据
MHC_CARDINTERFACE_API DWORD __stdcall wsc_GetCardInfo(HANDLE hDev,void *pvSelect,int nItem);
//按数据项序号写数据
MHC_CARDINTERFACE_API DWORD __stdcall wsc_PutCardInfo(HANDLE hDev,void *pvSelect,int nItem);
...
*/
MHC_CARDINTERFACE_API DWORD __stdcall SM3Digest(HANDLE hDev, BYTE *pbData, unsigned int nDataLen,  BYTE *pbHash, BYTE *pbHashLen);
...
*/
DWORD __stdcall SM2SignHash(HANDLE hDev,
								BYTE *pbData,
								BYTE bLen,
								BYTE *pbSignedData,
								BYTE *pbLength);
